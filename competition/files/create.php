  ...
  <div class="row">
   <div class="panel panel-success">
    ...
    <div class="well panel-body">
     <form enctype="multipart/form-data" method="POST" action="/events_app/competition/scripts/create.php" id="form-register">
      <div class="row col-md-pull-1 col-md-offset-1">
       <div class="col-md-5">
        <label for="nom"><h3>Titre:</h3></label>
        <input type="text" name="titre" id="nom" class="form-control" placeholder="Le Nom De  competition *" required="required">
      </div>
      <div class="col-md-5">
        <label for="slogan"><h3>Slogan</h3></label>
        <input type="text" name="slogon"  id="slogan" placeholder="le slogan de competition" class="form-control" required="required">
      </div>
    </div>
...
<div class="row col-md-pull-1 col-md-offset-1">
 <div class="col-md-5">
  ...
  <textarea rows="7" name="description"class="form-control" placeholder="Description de la competition" required="required"></textarea>                  
</div>
<div class="col-md-5">
...
<div class="col-md-5">
  ...
  <input type="number"  name="nbmax" id="slogan" placeholder="nombre des equipes maximum" class="form-control" required="required">
</div> 
...
<div class="row col-md-pull-1 col-md-offset-1">
 <div class="col-md-5">
  ...
  <input type="text" name="frais"  id="slogan" placeholder="frais de la competition" class="form-control" required="required">
...
<div class="row col-md-pull-1 col-md-offset-1">
 <div class="col-md-5">
  ...
  <input type="date" id="myDate" name="datedebut" value="2018-05-12" class="form-control" required="required">
</div>
<div class="col-md-5">
  <label for="premierphase"><h3>Date de Fin</h3></label> 
  <input type="date" id="myDate" name="datefin" value="2018-05-12" class="form-control" required="required">
</div>
...
<div class="row col-md-pull-1 col-md-offset-1">
 <div class="col-md-5">
  ...
  <input type="date" id="myDate" name="datelimite" value="2018-05-12" class="form-control" required="required">
</div>
<div class="col-md-2">
